...
export default class LogoQue extends React.PureComponent {
  state = {
    hoverKey: null,
  };
  onMouseOver = (key) => {
  ...
  render() {
    const children = teamData.map((item, i) => {
      return (
        <div
          className="fl w-100 w-50-m w-third-ns"
          key={item.name}
          md={6}
          xs={24}
        >
...
//           key={i}
//           // style={props}
//           className="fl w-100 w-50-m w-third-ns pa2"
//         >
//           <div className=" pt4">
